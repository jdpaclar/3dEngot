...
public class SpinMe : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // degrees frame^-1 = seconds frame^-1 / seconds minute^-1 * defrees rotation^-1 * rotation minute^-1
        // degrees frame^-1 = frame^-1 minute * defress rotation ^-1 * rotation minute^-1
        //degrees frame^-1 = frame^-1 * defress
